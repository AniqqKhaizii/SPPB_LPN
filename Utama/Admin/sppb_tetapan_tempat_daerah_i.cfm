                                    ...
                                    <tr class="border-t">
                                        ...
                                        <td class="border border-gray-300 py-2 px-2 text-center"> 
                                            <div class=" flex gap-2 items-center justify-center">
                                                <button id="openKemaskini#TMD_KOD#" type="button" class="flex gap-2 items-center justify-center bg-green-500 hover:bg-green-600 text-white py-2 px-2 rounded">
                                                    Kemaskini
                                                ...
                                                <button id="openHapus#TMD_KOD#" type="button" class="flex gap-2 items-center justify-center bg-red-500 text-white py-2 px-2 rounded hover:bg-red-700 transition duration-200 ">
                                                    Hapus 
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
