                ...
                <table class="min-w-full border border-gray-300">
                    ...
                    <cfoutput query="RS_DAERAH">
                        ...
                        <td class="border border-gray-300 py-2 px-4 text-center"> 
                            ...
                            <button id="openHapus#TMD_KOD#" type="button" class="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-700 transition duration-200 mt-2">
                                Hapus 
                            </button> 
                        </td>
                        </tr>
        ...
        <div class="p-6">
            <form id="form2" name="form2" method="post" action="">
                ...
                <div class="grid grid-cols-2 gap-4 mt-12">
                    <div class="space-y-4 col-span-1">
                        <div class="flex items-center justify-start">
                            <button type="submit" class="w-1/2 bg-blue-200 text-white font-medium py-2 px-4 rounded cursor-not-allowed" name="HAPUS_DATA" id="HAPUS_DATA#TMD_KOD#" disabled> 
                                Simpan
                            </button>
                        </div>
                    </div>
