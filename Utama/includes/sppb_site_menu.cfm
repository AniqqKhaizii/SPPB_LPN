<div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gray-950 text-white transform -translate-x-full lg:translate-x-0 transition-transform duration-300 lg:pt-16 lg:z-10 z-20">
    ...
    <nav class="flex-1 py-4 space-y-2 text-sm">
        <div class="relative">
            <input type="checkbox" id="PemajuDropdown" class="peer hidden">
            <label for="PemajuDropdown" class="flex justify-between items-center w-full py-2.5 px-4 hover:bg-gray-700 transition cursor-pointer peer-checked:bg-gray-900">
            ...
            <div class="max-h-0 overflow-hidden peer-checked:max-h-40 transition-all duration-500 ease-in-out space-y-2 peer-checked:bg-gray-900">
                ...
                <a href="/Pemaju/Projek" class="flex items-center space-x-2 gap-2 py-2.5 px-4 hover:bg-gray-700 transition pl-8">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="relative">
            ...
            <label for="SistemDropdown" class="flex justify-between items-center w-full py-2.5 px-4 hover:bg-gray-700 transition cursor-pointer peer-checked:bg-gray-900">
                <div class="flex items-center space-x-2">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="max-h-0 overflow-hidden peer-checked:max-h-64 peer-checked:bg-gray-900 transition-all duration-500 ease-in-out space-y-2">
                <div class="relative">
                    <input type="checkbox" id="TetapanDropdown" class="peer hidden">
                    <label for="TetapanDropdown" class="flex justify-between items-center w-full py-2.5 px-4 hover:bg-gray-700 transition cursor-pointer">
                        <div class="flex items-center space-x-2">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="max-h-0 overflow-hidden peer-checked:max-h-64 peer-checked:bg-gray-900 transition-all duration-500 ease-in-out space-y-2">
                        ...
                        <a href="/Tetapan/Tempat" class="flex items-center space-x-4 gap-2 py-2.5 hover:bg-gray-700 transition pl-8">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
