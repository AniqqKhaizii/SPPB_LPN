      ...
      <div class="swiper-wrapper">
       <div class="swiper-slide">
         <div class="bg-gradient-to-b from-zinc-300 to-[#f8f8f8] lg:h-screen xl:h-screen sm:h-[20vh] xs:h-[20vh] md:h-[30vh] flex justify-center items-center">
            <img src="../../public/assets/LoginImg.png" class="w-full h-full object-contain" alt="Image 1">
         </div>
       </div>
       <div class="swiper-slide">
         <div class="bg-gradient-to-b from-zinc-300 to-[#f8f8f8] lg:h-screen xl:h-screen sm:h-[20vh] xs:h-[20vh] md:h-[30vh] flex justify-center items-center">
            <img src="../../public/assets/LoginImg3.png" class="w-full h-full object-contain" alt="Image 1">
         </div>
       </div>
       <div class="swiper-slide">
         <div class="bg-gradient-to-b from-zinc-300 to-[#f8f8f8] lg:h-screen xl:h-screen sm:h-[20vh] xs:h-[20vh] md:h-[30vh] flex justify-center items-center">
            <img src="../../public/assets/LoginImg2.png" class="w-full h-full object-contain" alt="Image 1">
         </div>
       </div>
      </div>
