...
<section class="bg-gradient-to-b from-[#f0f0f0] to-[#f8f8f8]">
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section class="relative flex h-[50vh] items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      <img
        alt=""
...
<div class="mx-auto my-auto max-w-screen px-4 py-20 sm:px-6 lg:px-8">
  <div class="mx-auto my-auto max-w-screen-xl">
    ...
    <form action="./utama/utama.cfm" class="flex flex-col justify-around bg-transparent mb-0 mt-6 space-y-8 rounded-md p-12 sm:p-6 lg:p-12">
